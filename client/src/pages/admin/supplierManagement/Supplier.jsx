                                        ...
                                        >
                                            ...
                                            <td className="border px-4 py-2">
                                                <div className="flex flex-col">
                                                    <Link to={`/update-supplier/${supplier._id}`} className="bg-blue-500 text-white px-4 py-2 rounded mt-1 hover:bg-blue-600 text-center">Edit</Link>
                                                    <button onClick={() => handleDelete(supplier._id)} className="bg-red-500 text-white px-4 py-2 rounded mb-1 hover:bg-red-600">Delete</button>
                                                </div>

      ...
      <div className='bg-backgreen1'>
        <div className='flex flex-row justify-between items-center max-w-7xl mx-auto h-9'>
          ...
          <div className='flex flex-row justify-between'>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 text-textcolor1 mr-2">
      ...
      <div className='bg-backgreen2'>
        <div className='flex flex-row justify-between items-center max-w-7xl mx-auto h-20'>
          ...
          <div className='text-white text-sm flex flex-row justify-between items-center '>
            <Link to='/'><div className='mr-14 hover:opacity-50'><a href='#'>Home</a></div></Link>
            ...
            <Link to='/product-view-client'><div className='mr-14 hover:opacity-50'><a href='#'>Products</a></div></Link>
...
<div className='relative'>
              <button onClick={handleToggleCart} className=" text-white focus:outline-none">
              ...
              <Link to='/sign-in' ><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-8 h-8 text-white">
              <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 0 0-16.536-1.84M7.5 14.25 5.106 5.272M6 20.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm12.75 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" />
            </svg></Link>
            )}
            </div>
